...
This document defines the public API surface of the **`turbocable_nats`** gem (the `Turbocable` module) and the compatibility promises made for the **1.0.x** line (from **1.0.0** onward). The latest patch on this line is **1.0.2**.
